...
if not lista_de_videos:
    print(f"Nenhum arquivo de vídeo '{extensao_video}' encontrado na pasta '{pasta_entrada}'.")
    exit()

print(f"Encontrados {len(lista_de_videos)} vídeos para processar em '{pasta_entrada}':")
...
for caminho_do_video in lista_de_videos:
    ...
    print(f"\nProcessando vídeo: {os.path.basename(caminho_do_video)}")
    ...
    cap.release()
    print(f"  -> Processamento de '{os.path.basename(caminho_do_video)}' concluído.")
