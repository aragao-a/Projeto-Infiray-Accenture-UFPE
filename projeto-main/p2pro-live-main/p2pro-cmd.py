...
if __name__ == '__main__':
    ...
    cam_cmd = P2Pro()
    print(cam_cmd)
    print(cam_cmd._standard_cmd_read(CmdCode.cur_vtemp, 0, 2))
    #print(cam_cmd._standard_cmd_read(CmdCode.shutter_vtemp, 0, 2))
    #cam_cmd.pseudo_color_set(0, PseudoColorTypes.PSEUDO_IRON_RED)